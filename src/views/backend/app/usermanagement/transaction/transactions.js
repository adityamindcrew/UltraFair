        ...
        <div className="transaction-container">
          <div className="transaction-option_card ">
            <div style={{ display: "flex", flexDirection: "column" }}>
             ...
             <span className={depositToggle?"mr5":""}>   Deposits
 </span>             </div>
              {depositToggle ? (
                <div />
              ) : (
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              >        {!depositToggle ? (
                ...
                <span className={!depositToggle?"mr5":""}>    Withdrawals </span>
              </div>
              {depositToggle ? (
                <div className="optionsUnderlineMobile"  />
              ) : (
          ...
          <div className="transaction-type_card ">
            <div style={{display:'flex',flexDirection:'column',}}>
              ...
              <Select options={categoryGroup} styles={customStyles} placeholder={"Select"}/>
            </div>
            <br />
            <br />
            <div
