        ...
        <Container fluid>
           <Row >
            ...
            <div className="iq-search-bar Searchit" style={{background:"#13212D",borderRadius:"30px",width:"70%",marginTop:"3%",marginBottom:"3%",display:"flex",justifyContent:"flex-start"}}   >
                 ...
                 <Customslider classnm="testclass" classnm2="testclass" title="Ultrafair Origianls"/>
                 <Customslider classnm="testclass1" classnm2="testclass2" title="Slots"/>
                 <CardSwiper/>
                 <Customslider classnm="testclass1" classnm2="testclass2" title="Live Casino"/>
                 <Customslider classnm="testclass1" classnm2="testclass2" title="Table Games"/>
                 <Customslider classnm="testclass1" classnm2="testclass2" title="New Releases"/>
