            ...
            <Row className="wallet-QR-row">
                <div className="wallet-address-deposit">
                    <div className="wallet-link">
                        <span className="wallet-linl-text">3JZ9uHgrt566Yhfyuk9467xFFk998ILlkh</span>
                    </div>
                ...
                <InputGroup className="mb-3">
                    ...
                    <div style={{ backgroundColor: '#344452', borderBottomRightRadius: 5, borderTopRightRadius: 5 }}>
                        <Dropdown>
                            ...
                            <Dropdown.Menu>
                                <Dropdown.Item href="#/action-1">Acion</Dropdown.Item>
                                <Dropdown.Item href="#/action-2">Another action</Dropdown.Item>
                                <Dropdown.Item href="#/action-3">Something else</Dropdown.Item>
                            </Dropdown.Menu>
                        </Dropdown>
