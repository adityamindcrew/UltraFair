          ...
          <div class="contain">
                ...
                <li>
                  ...
                  <div className="d-flex flex-row">
                    ...
                    <div style={{ marginLeft: "5px" }}>
                      <img src={Vector} height="12px" width="12px" />
                    </div>
                  </div>
                </li>
                <li>Live Support</li>
            ...
            <div class="col col-hide">
              ...
              <ul>
                <li>
                  ...
                  <div className="d-flex flex-row ">
                    <div className="pt-1 mt-1">
                      <img src={Flag} height="25px" width="25px" />
                    </div>{" "}
                    <select
                ...
                <li>
                  <div
                    style={{ width: "114px", marginLeft: "-5px", padding: "0" }}
                  >
                    <select
                      style={{
                        padding: "0",
            ...
            <div className="p-2">
              ...
              <center className="pb-4 d-flex justify-content-center">
                {" "}
                <div className="m-2">
                  <BitcoinsSVG />
                </div>
              ...
              <center>
                <p className="mainfootertext">
                  © 2022 Ultrafair.com | All Rights Reserved.
                </p>
              </center>
              <center>
                <h5 className="mb-4 mainfootertext">1 BTC = $22,624.43</h5>
              </center>
              <center>
                <div className="footertext">
                  Ultrafair is owned and operated by Medium Rare N.V.,
                  registration number: 145353, registered address: Fransche
                  Bloemweg, 4 Willemstad Curaçao. Contact us at
                  mailto:support@ultrafair.com. Payment agent company is Medium
                  Rare Limited with address 7-9 Riga Feraiou, LIZANTIA COURT,
                  ...
                  License No. 8048/JAZ issued to Antillephone. Stake has passed
                  all compliance and is legally authorized to conduct gaming
