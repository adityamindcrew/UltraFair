    ...
    return (
        <>
            ...
            <div className="iq-sidebar-logo d-flex justify-content-between">
                    ...
                    <img src={logoicon} className="img-fluid-one rounded-normal" height="20px" width="20px" onClick={minisidbar} alt=""/>
                    <div className="logo-title">
                        <span className="text-primary text-uppercase"><img src={logotext} className="img-fluid-one rounded-normal"  alt=""/></span>
                    </div>
                    </Link>
                ...
                <div className="data-scrollbar" data-scroll="1" id="sidebar-scrollbar">
                    <nav className="iq-sidebar-menu">
                        <Accordion as="ul" id="iq-sidebar-toggle" className="iq-menu" onSelect={(e) => setActiveMenu(e)}>
                            ...
                            {/* <li className={activeMenu === '0' ? 'active' : ''}>
                                ...
                                <Accordion.Collapse className="submenu" eventKey="0">
                                    <ul id="category" className="iq-submenu " data-parent="#iq-sidebar-toggle">
                                        <li className={`${location.pathname === '/cassino/add-category' ? 'active' : ''} `}>
                                            <Link to="/cassino/add-category">

                                                Add Category
                                            </Link>
                                        </li>
                                        <li className={`${location.pathname === '/cassino/category-list' ? 'active' : ''} `}>
                                            <Link to="/cassino/category-list">
                                                Category List
                                            </Link>
                                        </li>
                                    </ul>
                            ...
                            <li className={`${location.pathname === '/challanges' ? 'active' : ''} `}>
                                <Link to="/challanges" className="iq-waves-effect">
                                    <ChallengesSVG />
                            ...
                            <li className={`${location.pathname === '' ? 'active' : ''} `}>
                                <Link to="" className="">
                                    ...
                                    {/* <i className="las la-user-friends"></i> */}
                                    <div><select className="form-control-dropdown-topbar" id="exampleFormControlSelect2">
